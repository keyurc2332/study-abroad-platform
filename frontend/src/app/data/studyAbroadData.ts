...
export type ResumeBuilderData = {
  ...
  github: string;
  summary: string;
  education: { institution: string; degree: string; dates: string; description: string }[];
...
export const STORAGE_KEYS = {
  ...
  resumeBuilder: "study-abroad-resume-builder",
  sopGenerator: "study-abroad-sop-generator",
  lorGenerator: "study-abroad-lor-generator",
} as const;
...
export type SopData = {
  ...
  projectsAndInternships: string;
  skills: string;
  familyBackground: string;
  strengths: string;
  strengthExamples: string;
  uniqueAspects: string;
  institutionsOfChoice: string;
  ...
  designationAndRole: string;
  whyHigherEducation: string;
  workSummary: string;
  careerProgression: string;
  standoutProjects: string;
  professionalAccomplishments: string;
...
export const defaultLorData: LorData = {
  recommenderName: "",
  recommenderPosition: "",
  relationship: "",
  durationKnown: "",
...
export const defaultSopData: SopData = {
  personalBrief: "",
  academicBackground: "",
...
export const defaultResumeBuilder: ResumeBuilderData = {
  fullName: "Aarav Sharma",
  email: "aarav.sharma@email.com",
  phone: "+91 98765 43210",
  ...
  summary:
    "Experienced computer science graduate with strong academic background and professional experience in software development. Seeking a Master's program to grow technical skills and work on research-driven projects.",
  education: [
    {
      institution: "Indian Institute of Technology, Delhi",
      degree: "B.Tech in Computer Science",
      dates: "2020 - 2024",
      description: "Graduated with a 8.4/10 GPA, completed advanced coursework in algorithms and machine learning.",
    },
  ],
  experience: [
    {
      ...
      description: "Built a full-stack feature for student outcomes tracking using React and Node.js.",
    },
  ],
  achievements: [
    "Implemented a cross-functional agent farm to automate workflows and reduce manual intervention",
    "Reduced debugging time by 25% through structured development practices",
  ],
  extracurriculars: [
    "Open-source contributor to student-focused cloud automation tools",
    "Volunteer mentor for campus AI clubs and hackathons",
  ],
