...
export default function Home() {
  ...
  return (
    <main className="px-3 pb-4 sm:px-4 lg:px-5">
      ...
      >
        <section role="banner" aria-label="Landing hero" className="relative min-h-[520px] overflow-hidden bg-[linear-gradient(112deg,#ffffff_0%,#fbfdff_45%,#edf5ff_100%)]">
          <motion.div
          ...
          <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center px-6 pb-32 pt-20 sm:px-10 lg:grid-cols-[0.83fr_1.17fr] lg:px-16 lg:pb-36 lg:pt-24">
            <motion.div
            ...
            >
              <h1 className="max-w-[620px] text-3xl leading-tight text-slate-950 sm:text-[40px] md:text-[48px] lg:text-[58px]">
                Explore the world
              ...
              <motion.div
                ...
                className="mt-9 flex max-w-[560px] flex-col gap-4 sm:flex-row"
              >
                <Link
                  to="/dashboard"
                  aria-label="Start now"
                  className="inline-flex h-14 flex-1 items-center justify-center gap-3 rounded-3xl bg-blue-600 px-6 text-sm font-semibold text-white shadow-[0_14px_30px_rgba(37,99,235,0.28)] transition-colors hover:bg-blue-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-300"
                >
                ...
                <Link
                  ...
                  className="inline-flex h-14 flex-1 items-center justify-center gap-2 rounded-3xl border border-slate-200 bg-white px-6 text-sm font-semibold text-slate-700 shadow-sm hover:bg-slate-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-200"
                >
              ...
              >
                <div className="flex -space-x-3" aria-label="Trusted by students" role="img">
          ...
          <div aria-hidden className="absolute bottom-0 left-0 right-0 h-[92px] bg-[linear-gradient(96deg,rgba(37,99,235,0.98)_0%,rgba(59,130,246,0.85)_34%,rgba(124,58,237,0.58)_72%,rgba(147,197,253,0.75)_100%)] [clip-path:polygon(0_53%,17%_68%,39%_33%,63%_30%,82%_50%,100%_42%,100%_100%,0_100%)] pointer-events-none" />
        </section>
        ...
        <motion.section
          ...
          variants={sectionReveal}
          className="relative z-20 -mt-12 px-6 py-12 sm:px-10 lg:px-16 lg:py-16"
        >
